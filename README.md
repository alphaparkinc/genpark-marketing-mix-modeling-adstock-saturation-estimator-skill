# genpark-marketing-mix-modeling-adstock-saturation-estimator-skill
...
> **GenPark AI Agent Skill** -- Marketing Mix Modeling (MMM) adstock & saturation estimator (Robyn style)
